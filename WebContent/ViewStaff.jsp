<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.model.Staff" import="java.util.*"  import="com.model.Department"%>
    <!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
...
List<Staff> s2;
s2=s.showStaff();
String e,u,pwd;int ph,p,uid;int v,did;String dnm;
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Staff Members</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms"></p>
              
          <%if(s2.isEmpty())
{%><h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">No Staff Registered</h1><%}else{
          out.println(" <div class='tbl-header'><table border='1'><tr><td>User Id</td><td>User Name</td><td>Email</td><td>Department Id</td>"
        		  +"<td>Permission</td><td>Department Name</td><td>Password</td><td>Value</td><td>Delete</td></tr></table></br></div>");
          for (Staff uu : s2) 
          {
          /* out.println(ss); */
          u=uu.getUser_name();
          ...
          e=uu.getEmail();
          uid=uu.getUser_id();
out.println(" <div class='tbl-header'><table border='1'><tr><td>"+uid+"</td><td>"+u+"</td><td>"+e+"</td><td>"+did+"</td><td>"+p+
		"</td><td>"+dnm+"</td><td>"+pwd+"</td><td>"+v+"</td><td><a href=\"delS.jsp?cId="+uid+"\">Delete Staff</a></td></tr></table></br></div>");
}}
