<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.model.Query" import="java.util.List"%>
    <!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
 ...
 <% int ccc=(Integer)session.getAttribute("cId");


/* int ccc=Integer.parseInt(c); */
Query q=new Query();List<Query> qli;
qli=q.getQ(ccc);
%>
<!-- out.println("<h1>Queries</h1>"); -->
      ...
      <div class="container">      
        <div class="row justify-content-md-center">
          ...
          <%if(qli.isEmpty())
{%><h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">No Queries to be Shown</h1><%}else{
          out.println(" <div class='tbl-header'><table border='1'><tr><td>Query Id</td><td>User Id</td><td>Query</td><td>Issue Type</td><td>Department Id</td>"
        		  +"<td>Response</td><td>Status</td><td>Delete</td></tr></table></br></div>");
for (Query query : qli) 
{int uid,dId,qId;String qu,r,s,iss;
uid=query.getUser_id();
dId=query.getDept_id();
qId=query.getQuery_id();
qu=query.getQuery();
iss=query.getIssue();
r=query.getResponse();
s=query.getStatus();
out.println(" <div class='tbl-header'><table border='1'><tr><td>"+qId+"</td><td>"+uid+"</td><td>"+qu+"</td><td>"+iss+"</td><td>"+dId+
"</td><td>"+r+"</td><td>"+s+"</td><td font-color='black'><a href=\"delQ.jsp?qId="+qId+"_cId="+ccc+"\">Delete Query</a></td></tr></table></br></div>");
}
