...
System.out.println("cid idddddd"+ccc);
...
%>
 <div class="container">      
        <div class="row justify-content-md-center">
          ...
          <%if(qli.isEmpty())
{%><h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">No Queries to be Resolved</h1><%}else{
          out.println(" <div class='tbl-header'><table border='1'><tr><td>Query Id</td><td>User Id</td><td>Query</td><td>Department Id</td>"
        		  +"<td>Response</td><td>Status</td><td>Delete</td></tr></table></br></div>");
          for (Query query : qli) 
          {int uid,dId,qId;String qu,r,s;
          ...
          r=query.getResponse();
          s=query.getStatus();
out.println(" <div class='tbl-header'><table border='1'><tr><td>"+qId+"</td><td>"+uid+"</td><td>"+qu+"</td><td>"+dId+
		"</td><td>"+r+"</td><td>"+s+"</td><td><a href=\"Response.jsp?qId="+qId+"\">Write Response</a></td></tr></table></br></div>");
}}
