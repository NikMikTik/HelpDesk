...
<html lang="en">
  ...
  <body>
 <%String name= (String)request.getParameter("nme");
 String password= (String)request.getParameter("pwd");
 System.out.println("voooooooooovovvvvvvvvvvvvvvvv"+name+password);
if(name.equals("")||password.equals(""))
{response.sendRedirect("Login.jsp");}

User uu=new User();
int kki;
int kk=uu.validate(name,password);
session.setAttribute("kk", kk);
int to=uu.idgetter(name, password); 
session.setAttribute("name", name);
session.setAttribute("password", password);
session.setAttribute("cId", to);
if(kk!=0)
{response.sendRedirect("LoginSubmit.jsp");}
else
{
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Enter Correct Login Details. Or Please register First</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms"></p>
              <a href="Login.html" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Go to Login</a>
            </div>
          </div>
        </div> 
      </div>           
