...
<html lang="en">
  ...
  <body>
 <% int tim=(Integer)session.getAttribute("kk");
 String timi=(String)session.getAttribute("name");
int to=(Integer)session.getAttribute("cId");
int kki;
%>    <header id="hero-area" data-stellar-background-ratio="0.5">  <%
if(tim==0)
{out.println("Enter Correct Login Details. Or Please register First"+"<a href='Login.jsp'>Go TO Login/Register</a>");}
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Welcome <%=timi %></h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Choose from Below Options</p>
              <a href="createQ.jsp?cId=<% out.print(to); %>" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Create Query</a>
               <a href="ViewQ.jsp?cId=<% out.print(to); %>" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">View Query</a>
                <a href="Logout.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Logout</a>
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Welcome <%=timi %></h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Choose from Below Options</p>
              <a href="GResponseQ.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Give Response Query</a>
               <a href="ViewSQ.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">View Query</a>
                <a href="Logout.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Logout</a>
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Welcome <%=timi %></h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Choose from Below Options</p>
              <a href="addStaff.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Add Staff</a>
               <a href="ViewAllQ.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">View All Queries</a>
                <a href="ViewStaff.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">View All Staff Details</a>
                  <a href="ViewCustomer.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">View All Customers</a>
                    <a href="Logout.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Logout</a>
    ...
    <footer>          
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-sm-6 col-xs-12">
            <div class="copyright">
             <center> <p align="center">&nbsp;Designed & Developed by Nikita | Shefali | Adnan</p><center>
            </div>
          </div>  
        </div>
      </div>
