<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.model.Customer" import="java.util.*" %>
    <!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
...
c1=c.showCustomer();
String e,u,pwd;long ph;int d,p,uid;
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Users</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms"></p>
              
          <%if(c1.isEmpty())
{%><h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">No Users Registered</h1><%}else{
          out.println(" <div class='tbl-header'><table border='1'><tr><td>User Id</td><td>User Name</td><td>Email</td><td>Phone No</td>"
          ...
          e=uu.getEmail();
          uid=uu.getUser_id();
out.println(" <div class='tbl-header'><table border='1'><tr><td>"+uid+"</td><td>"+u+"</td><td>"+e+"</td><td>"+ph+"</td><td>"+p+
		"</td><td>"+pwd+"</td><td><a href=\"delC.jsp?cId="+uid+"\">Delete Customer</a></td></tr></table></br></div>");
}
