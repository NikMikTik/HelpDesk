<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.model.Query" import="com.model.User" import="java.util.*"%>
    <!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
...
String nme=request.getParameter("qname");
String iss=request.getParameter("iss_name");
String name,pwd;String Np;String[] pp;
String rrr,res,ii;int i;
int ccc=Integer.parseInt(c);
User uu=new User();String hhq,hhr;
List<Query> qt;
Query q=new Query();
rrr=q.knowledge(nme);
System.out.println("ytytytytytyyt"+rrr);
String[] p=rrr.split("_");
res=p[0];
ii=p[1];
i=Integer.parseInt(ii);System.out.println("i in hereeee is"+i+"vovovovovo"+res);%>
 <div class="container">      
        <div class="row justify-content-md-center">
          ...
          <%if(i==2)
{%><h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">According to the Knowledge Base... Solution to your query is:</h1>
<h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s"><%=res %></h1><%
qt=q.getknowledge();
for (Query qu : qt){ 
hhq=qu.getQuery();
hhr=qu.getResponse();
       ...
       <!--  <div class="section-header">          
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-xs-12">
           <!--  <div class="show-box">
              <img class="img-fulid" src="img3/features/images.jpg" alt="">
            </div> -->
          </div>
        </div>
      </div>
...
<%
          ...
          {if(q.enterQ(nme, ccc,iss)==true)
          {out.println("Query Inserted");
          response.sendRedirect("ViewQ.jsp");
          Np=uu.getNamePwd(ccc);
          pp=Np.split("_");
          name=pp[0];
          pwd=pp[1];

          System.out.println("name issss"+name);
          System.out.println("pwd issss"+pwd);
          }
          else if(i==0)
          	out.println("Query Not Inserted...");
          out.println("");}
