...
String[] p=qim.split("_");
String qq=p[0];//qid-
String c=p[1];//cidd
String[] pp=c.split("=");
String cc=pp[1];//cid
int t=Integer.parseInt(qq);//final qid
int tt=Integer.parseInt(cc);//final cid
Query q=new Query();
if(q.alloS(t,tt)==true)
{%>
 <div class="container">      
   ...
   <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Staff Allocated</h1>
   <%
   }
   %>
