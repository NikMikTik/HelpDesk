<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.model.User"%><!DOCTYPE html>
	...
	<div id="wrapper">
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="adjust-nav">
				...
				<span class="logout-spn"> <a href="Logout" style="color: #fff;">LOGOUT</a>
				...
				<div class="row">
					<div class="col-lg-12 ">
						<div class="alert alert-info">
							<strong>Welcome Staff! </strong> You Have No pending Task For
							Today.
						</div>
				...
				<div class="row text-center pad-top">
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="GResponseQ.jsp"> <i class="fa fa-user fa-5x"></i>
								<h4>Give Response to Query</h4>
							</a>
						</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="ViewSQ.jsp"> <i class="fa fa-clipboard fa-5x"></i>
								<h4>View Staff Queries</h4>
							</a>
						</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="ViewStaff.jsp"> <i class="fa fa-users fa-5x"></i>
								<h4>View Staff Detail</h4>
							</a>
						</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="ViewCustomer.jsp"> <i class="fa fa-users fa-5x"></i>
								<h4>View Customers Detail</h4>
							</a>
						</div>
