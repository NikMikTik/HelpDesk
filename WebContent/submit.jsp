...
<html lang="en">
  ...
  <body>    <header id="hero-area" data-stellar-background-ratio="0.5">  
  <%
		System.out.println("In Submity");
	%>
	<%
		long Ph;
		int E = 0;
		...
		if (Email.indexOf('@') < 0) {
			out.println("Wrong Email Id Format.. Eg:Abc@xyz.com");
			response.sendRedirect("Register.html");
			E = 1;
		}System.out.println("E issssssss"+E);
		String phone_no = (String) request.getParameter("Phone");
		if (phone_no.equals("")) {
			Ph = 0;
		} else
			Ph = Long.parseLong(phone_no);
		if (phone_no.length() != 10) {
			out.println("Wrong Phone Number.. Enter 10 Digits");
			Ph = 1;
		}
		System.out.println("phhhhhhhhhhhhhhhhhh" + Ph);
		if (name.equals("") || password.equals("") || Email.equals("") || Ph == 0) {
			response.sendRedirect("Register.html");
		}
		System.out.println("IN SUBMIT JSP");
		Customer c = new Customer();
		if(Ph != 1 && E != 1)
			if (c.enter(name, Ph, Email, password) == true) {
	%>
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">NEW CUSTOMER REGISTERED</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">To Know More... Scroll Down</p>
              <a href="Login.jsp" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Login from Here</a>
            </div>
          </div>
        </div> 
      </div>  
