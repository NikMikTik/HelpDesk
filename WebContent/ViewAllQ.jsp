<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.model.Query" import="java.util.*"%>
    <!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
...
if(q1.isEmpty())
{out.println("No Queries to be Shown\n");} */
String query,res,status,iss;int did,p,uid,qid;
...
{%><h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">No Queries to be Shown</h1><%}else{
          out.println(" <div class='tbl-header'><table border='1'><tr><td>User Id</td><td>Department Id</td><td>Query Id</td><td>Query</td><td>Issue Type</td>"
        		  +"<td>Response</td><td>Status</td><td>Delete</td><td>Allocation</td></tr></table></br></div>");
          for (Query qu : q1) 
          {uid=qu.getUser_id();
          did=qu.getDept_id();
          qid=qu.getQuery_id();
          ...
          iss=qu.getIssue();
          status=qu.getStatus();
out.println(" <div class='tbl-header'><table border='1'><tr><td>"+uid+"</td><td>"+did+"</td><td>"+qid+"</td><td>"+query+"</td><td>"+iss+"</td><td>"+res+
		"</td><td>"+status+"</td><td><a href=\"delAQ.jsp?qId="+qid+"\">Delete Query</a></td><td><a href=\"allocateS.jsp?qId="+qid+"\">Allocate Staff</a></td></tr></table></br></div>");
}
